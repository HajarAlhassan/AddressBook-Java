...
public class Main {
    ...
    public static void addAction() throws IOException {
        ...
        String email;
             ...
             if(Validation.exitApp(fname)){//If Q/Quit exit the application
                DatabaseFile.saveToDatabase(addressBook);
                 System.exit(0) ;}
    ...
    ////////////////////////// Do Delete address book Action /////////////////////////////////////////////
    public static void deleteAction() throws IOException {
        addressBook.deleteAddressBook();
    }
    ////////////////////////// Do Print Action /////////////////////////////////////////////
    public static void printAction(){
        Collections.sort(addressBook.getAddressBook(),Entry.EntryNameComparator);
    ...
    public static void main(String[] args) throws IOException {
        ...
        DatabaseFile.readDatabase(addressBook.getAddressBook());
        Collections.sort(addressBook.getAddressBook(),Entry.EntryNameComparator);
        String quit="";
       out:
        do{
